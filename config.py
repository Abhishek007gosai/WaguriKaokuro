...
class Config(object):
    ...
    BOT_USERNAME = os.environ.get("BOT_USERNAME", "Auto_Rename_XRoBot")
...
ᴀᴅᴍɪɴ sᴜᴘᴘᴏʀᴛ @EternalsHelplineBot</b>"""
...
<b>‣ ꜰᴏʀ ᴇx:- </b> <code> /autorename [S{season} E{episode}] Your Anime Name [Quality] [Audio] @AnimeNexusNetwork</code>
