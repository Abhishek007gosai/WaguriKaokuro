...
class Config(object):
    ...
    BOT_USERNAME = os.environ.get("BOT_USERNAME", "YoruXRobot")
...
<b>‣ ꜰᴏʀ ᴇx:- </b> <code> /autorename Your Anime Name Here [SSeason] [EPEpisode] [Quality] [Audio] @AnimeNexusNetwork </code>
